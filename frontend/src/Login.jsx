...
const Login = ({ alCambiarDeVista, alIniciarSesion }) => {
  ...
  const manejarLogin = async (e) => {
    ...
    try {
      ...
      // Si el backend responde bien, iniciamos sesión en la app
      alIniciarSesion({
        id: datos.usuario_id,
  ...
  return (
    <div style={{ maxWidth: '400px', margin: '50px auto', padding: '20px', border: '1px solid #ccc', borderRadius: '8px' }}>
      ...
      <p style={{ fontSize: '14px', color: '#666' }}>Ingresa para gestionar tus apuestas del Mundial</p>
      ...
      <p style={{ marginTop: '15px', textAlign: 'center', fontSize: '14px' }}>
        ...
        <button onClick={() => alCambiarDeVista('registro')} style={{ background: 'none', border: 'none', color: '#007bff', textDecoration: 'underline', cursor: 'pointer', padding: 0 }}>
          Regístrate aquí
        </button>
      </p>
    </div>
